...
//        id = assignID();
        ...
        score = Integer.parseInt(String.valueOf(Main.getInstance().getDb().getDetails().get(2)));
        coin_count = Integer.parseInt(String.valueOf(Main.getInstance().getDb().getDetails().get(3)));
        System.out.println("yp");
        if(score > 100){
            //Call Ending
        }
        if(Main.getInstance().getDb().getDetails().get(5).equals("axe")){
        ...
        }else if(Main.getInstance().getDb().getDetails().get(5).equals("spear")){
